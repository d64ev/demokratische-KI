...
<div class="">
	<dl class="!mt-0 grid grid-cols-2 font-sans w-full text-base">
	...
	<dl>
		...
		<?php if ( ! empty( $phone ) ): ?>
			<dt class="tribe-venue-tel-label sr-only"> <?php esc_html_e( 'Phone', 'the-events-calendar' ) ?> </dt>
			<dd class="tribe-venue-tel"> <?php echo $phone ?> </dd>
		<?php endif ?>

		<?php if ( ! empty( $website ) ): ?>
			<?php if ( ! empty( $website_title ) ): ?>
				<dt class="tribe-venue-url-label sr-only"> <?php echo esc_html( $website_title ) ?> </dt>
			<?php else: ?>
				<dt
					class="tribe-common-a11y-visual-hide sr-only"
					aria-label="<?php echo sprintf(
