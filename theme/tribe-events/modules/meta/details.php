...
?>
	...
	<dl class="!mt-0 grid grid-cols-2 font-sans w-full text-lg">
		<h2 class="text-sm font-semibold pt-[1px] w-full">wann</h2>
		<div class="">
		<?php
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<dt class="tribe-events-start-date-label sr-only"> <?php esc_html_e( 'Start:', 'the-events-calendar' ); ?> </dt>
			<dd>
			...
			<dt class="tribe-events-end-date-label sr-only"> <?php esc_html_e( 'End:', 'the-events-calendar' ); ?> </dt>
			<dd>
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<dt class="tribe-events-start-date-label sr-only"> <?php esc_html_e( 'Date:', 'the-events-calendar' ); ?> </dt>
			<dd>
				<abbr class="tribe-events-abbr tribe-events-start-date published dtstart" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_date ); ?> </abbr>
			</dd>
		...
		elseif ( tribe_event_is_multiday() ) :
			...
			<dt class="tribe-events-start-datetime-label sr-only"> <?php esc_html_e( 'Start:', 'the-events-calendar' ); ?> </dt>
			<dd>
			...
			<dt class="tribe-events-end-datetime-label sr-only"> <?php esc_html_e( 'End:', 'the-events-calendar' ); ?> </dt>
			<dd>
		...
		// Single day events
			...
			<dt class="tribe-events-start-time-label sr-only"> <?php echo esc_html( $time_title ); ?> </dt>
			<dd>
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<dt class="tribe-events-event-cost-label sr-only"> <?php esc_html_e( 'Cost:', 'the-events-calendar' ); ?> </dt>
		...
		if ( ! empty( $website ) ) : ?>
			<?php if ( ! empty( $website_title ) ): ?>
				<dt class="tribe-events-event-url-label sr-only"> <?php echo esc_html( $website_title ); ?> </dt>
			<?php endif; ?>
